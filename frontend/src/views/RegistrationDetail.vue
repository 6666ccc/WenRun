...
async function load() {
  ...
  try {
    ...
    registration.value = registrations.value.find((item) => String(item.id) === String(route.params.id))
...
async function reschedule() {
  ...
  try {
    await rescheduleRegistration(Number(route.params.id), Number(targetScheduleId.value))
